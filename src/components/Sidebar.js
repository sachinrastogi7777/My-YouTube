  ...
  return (
    <div className="col-span-1 px-7 md:p-5 md:pt-2 lg:p-7 lg:pt-2 lg:px-5 mt-5 md:m-0">
      <div className="flex flex-col justify-start border-b-[1px] border-gray-300 pb-2">
        ...
        >
          <p className="flex items-center justify-center md:justify-start py-2 md:px-2 txt-sm md:text-base cursor-pointer hover:bg-red-200 hover:rounded-lg">
        ...
        <Link
          ...
          className={
            selectedTab === "/subscriptions" ? "bg-gray-200 rounded-lg" : ""
          }
        >
          <p className="flex items-center justify-center md:justify-start py-2 md:px-2 txt-sm md:text-base cursor-pointer hover:bg-red-200 hover:rounded-lg">
            <MdOutlineSubscriptions className="text-base md:text-xl mr-2" />{" "}
            Subscriptions
          </p>
        </Link>
      </div>
      <div className="flex flex-col justify-start border-b-[1px] border-gray-300 py-2">
        <Link
          to="/watchlater"
          onClick={() => {
            setSelectedTab("/watchlater");
          }}
          className={
            selectedTab === "/watchlater" ? "bg-gray-200 rounded-lg" : ""
          }
        >
          <p className="flex items-center justify-center md:justify-start py-2 md:px-2 txt-sm md:text-base cursor-pointer hover:bg-red-200 hover:rounded-lg">
      ...
      <div className="flex flex-col justify-start border-b-[1px] border-gray-300 py-2">
        <Link
          to="/feed/film"
          onClick={() => {
            setSelectedTab("/feed/film");
          }}
          className={
            selectedTab === "/feed/film" ? "bg-gray-200 rounded-lg" : ""
          }
        >
          <p className="flex items-center justify-center md:justify-start py-2 md:px-2 txt-sm md:text-base cursor-pointer hover:bg-red-200 hover:rounded-lg">
        ...
        <Link
          to="/feed/music"
          onClick={() => {
            setSelectedTab("/feed/music");
          }}
          className={
            selectedTab === "/feed/music" ? "bg-gray-200 rounded-lg" : ""
          }
        >
          <p className="flex items-center justify-center md:justify-start py-2 md:px-2 txt-sm md:text-base cursor-pointer hover:bg-red-200 hover:rounded-lg">
        ...
        <Link
          ...
          className={
            selectedTab === "/feed/sports" ? "bg-gray-200 rounded-lg" : ""
          }
        >
          <p className="flex items-center justify-center md:justify-start py-2 md:px-2 text-sm md:text-base cursor-pointer hover:bg-red-200 hover:rounded-lg">
        ...
        <Link
          ...
          className={
            selectedTab === "/feed/gaming" ? "bg-gray-200 rounded-lg" : ""
          }
        >
          <p className="flex items-center justify-center md:justify-start py-2 md:px-2 text-sm md:text-base cursor-pointer hover:bg-red-200 hover:rounded-lg">
            <IoGameControllerOutline className="text-base md:text-xl mr-2" />{" "}
            Gaming
          </p>
        </Link>
        <Link
          ...
          className={
            selectedTab === "/feed/news" ? "bg-gray-200 rounded-lg" : ""
          }
        >
          <p className="flex items-center justify-center md:justify-start py-2 md:px-2 text-sm md:text-base cursor-pointer hover:bg-red-200 hover:rounded-lg">
        ...
        <Link
          ...
          className={
            selectedTab === "/feed/education" ? "bg-gray-200 rounded-lg" : ""
          }
        >
          <p className="flex items-center justify-center md:justify-start py-2 md:px-2 text-sm md:text-base cursor-pointer hover:bg-red-200 hover:rounded-lg">
        ...
        <Link
          ...
          className={
            selectedTab === "/feed/science" ? "bg-gray-200 rounded-lg" : ""
          }
        >
          <p className="flex items-center justify-center md:justify-start py-2 md:px-2 text-sm md:text-base cursor-pointer hover:bg-red-200 hover:rounded-lg">
